var Notify = function() {
    ...
    return function() {
        ...
        return o.prototype.checkRequirements = function() {
            ...
            e.classList.add("notify__title"), e.textContent = this.title, this.showCloseButton || (e.style.paddingRight = "0");
